...
ActiveRecord::Schema.define(:version => 20121204121644) do
  ...
  create_table "assignments", :force => true do |t|
    ...
    t.integer  "bookmarkrating_questionnaire_id"
  ...
  add_index "assignments", ["bookmarkrating_questionnaire_id"], :name => "fk_assignments_bookmarkrating_questionnaires"
